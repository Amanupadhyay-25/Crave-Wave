...
const RestaurantCard = (props) => {
  const { loggedInUser } = useContext(UserContext); // Here using Context API
  ...
  return (
    <div className="w-80 m-3 h-auto bg-gray-100 mb-10 mt-10 rounded-3xl shadow-2xl p-6 flex flex-col hover:bg-gray-300 shadow-slate-300 transition-transform duration-300 ease-in-out transform hover:scale-105">
      <div>
        <img
